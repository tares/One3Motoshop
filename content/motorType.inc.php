                ...
                <div id="section-right" class="dropShadow_lighter">
                    ...
                    <div id="paddingWrapper">
                    	...
                    	<div id="product-box-row">
                            <div id="brandWrapper">
                                <center>
                                    <div id="motorSeries_banner" style="background-image:url(source/images/product/type/honda_cbr150.png);"></div>
                                    <div id="motorSeries_banner" style="background-image:url(source/images/product/type/honda_cb150r.png);">&nbsp;</div>
                                    <div id="motorSeries_banner" style="background-image:url(source/images/product/type/honda_cb1000r.png);">&nbsp;</div>
                                </center>
                            </div>
                        </div>
