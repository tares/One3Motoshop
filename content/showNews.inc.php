        <div id="mainSection">
        	<div id="topBanner" style="background-image:url(source/images/banner/topBanner-3.png); background-repeat:no-repeat;">
        	...
        	<div id="productWrapper">
                ...
                <div id="section-right" class="dropShadow_lighter">
                    ...
                    <div id="paddingWrapper">
                    	<div class="news_date"><i>NOVEMBER 22 2012</i></div>
                    	<h1>MV AGUSTA & PARKINGO JOIN TOGETHER FOR WORLD SUPERSPORT RACING</h1>
                        
                        <hr />
                       	<img src="source/images/news/content/main.jpg" width="100%" height="auto" alt="MV Agusta" />
						<hr />
                   		<p>
                        	The Italian motorcycle manufacturer who is currently the sales leader of the middle weight supersport class has decided to return to racing on the world stage and is convinced that they have joined forces with the ideal partner: ParkinGO. The two companies will be joined together in a three year contract.
The program will debut the MV Agusta F3 675 in the 2013 world Supersport class together with additional racing activity development. The project will place the three cylinder bike from Varese in the able hands of the race technicians whom have already won the World Supersport Championship in 2011 and were contenders in the 2012 World Superbike Championship.
						</p>
